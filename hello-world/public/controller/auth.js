const firebaseConfig = {
    // please refer to the config in teams
};
...
// please refer to updateUserInfoInbottom()
// 更新用戶數據 (名字, 大頭照 url)
...
class UserInfo {
    constructor(username, avatar, into) {
        this.username = "Anon",
...
function updateUserDB(username = "Anon", avatar = "/public/assets/image/defaultAvatar.jpeg", intro = "I have something to say..."){
    retUserInfo().then(user => {
        const path = "/users/" + user.uid;
        const newUser = new UserInfo(username, avatar, intro);
